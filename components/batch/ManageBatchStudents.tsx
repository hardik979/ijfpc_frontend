      ...
      <div className="relative z-10 mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="mb-8 flex items-start gap-5">
          <div className="relative">
            ...
            <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl border border-white/20 bg-gradient-to-br from-rose-500/10 to-orange-500/10 backdrop-blur-sm">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] shadow-2xl backdrop-blur-xl">
          <div className="relative p-6 sm:p-8 lg:p-10">
            <div className="mb-8 flex items-center gap-3 border-b border-white/10 pb-6">
              ...
              <div>
                <p className="text-sm font-semibold text-white">Batch Roster</p>
                <p className="text-xs text-slate-500">View and remove students from a batch</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="rounded-2xl border-2 border-white/10 bg-white/[0.02] transition-all focus-within:border-rose-500/50 hover:border-white/20">
                  <select
                    value={batchId}
                ...
                <div className="mb-2.5 flex flex-wrap items-center justify-between gap-2">
                  ...
                  {batchId && selected.size > 0 && (
                    <button
                      ...
                      className="inline-flex items-center gap-2 rounded-xl border border-rose-500/30 bg-rose-500/10 px-3 py-1.5 text-xs font-semibold text-rose-200 transition hover:bg-rose-500/20 disabled:opacity-50"
                    >
                      {removingBulk ? (
